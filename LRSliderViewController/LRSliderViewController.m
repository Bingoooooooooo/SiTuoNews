...
@interface LRSliderViewController ()<UIGestureRecognizerDelegate>  {
...
@implementation LRSliderViewController
...
+ (LRSliderViewController*)sharedSliderViewController {

    static LRSliderViewController *sharedSliderViewController;
